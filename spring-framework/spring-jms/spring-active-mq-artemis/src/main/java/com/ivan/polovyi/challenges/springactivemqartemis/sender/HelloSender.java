package com.ivan.polovyi.challenges.springactivemqartemis.sender;
        ...
        Message receviedMsg = jmsTemplate.sendAndReceive(JMSConfig.MY_SEND_RCV_QUEUE, new MessageCreator() {
            ...
            public Message createMessage(Session session) throws JMSException {
                ...
                try {
                    ...
                    helloMessage.setStringProperty("_type", "com.ivan.polovyi.challenges.springactivemqartemis.model.HelloWorldMessage");
